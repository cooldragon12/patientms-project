...
import { Icon360, IconArrowBadgeLeft, IconArrowBadgeRight, IconHeart } from '@tabler/icons-react';
        ...
        <AppShell
            ...
            navbar={
                <Navbar width={{base:250}} hidden={open} >
                    <Navbar.Section>
                        <Group>
                            <IconArrowBadgeLeft size={"4rem"} onClick={()=>open ? setOpen(false):setOpen(true)}/>
                            <IconArrowBadgeRight size={"4rem"} onClick={()=>open ? setOpen(false):setOpen(true)}/>
                        </Group>
                    </Navbar.Section>
                    <Navbar.Section>
                    {
