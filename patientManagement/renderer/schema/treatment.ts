...
export type TreatmentRecordPrimary = Omit<TreatmentRecord, 'amount_charged'| 'amount_paid' | 'balance' | 'tooth_no'>;
export interface TreatmentRecordOverview extends TreatmentRecordPrimary, TreatmentRecordUrl{}
